    ...
    public ChiseledEumusBrickSecretButton(Properties properties, Block jadeBlock) {
        super(
                ...
                Shapes.or(BOTTOM, TOP,
                        Block.box(15, 4, 0, 16, 13, 16),
                        Block.box(8, 4, 3, 15, 13, 16),
                        Block.box(0, 4, 0, 8, 13, 16)
                ),
                Shapes.or(BOTTOM, TOP,
                        Block.box(0, 4, 15, 16, 13, 16),
                        Block.box(0, 4, 8, 13, 13, 15),
                        Block.box(0, 4, 0, 16, 13, 8)
                ),
                Shapes.or(BOTTOM, TOP,
                        Block.box(0, 4, 0, 1, 13, 16),
                        Block.box(1, 4, 0, 8, 13, 13),
                        Block.box(8, 4, 0, 16, 13, 16)
                ),
                Shapes.or(BOTTOM, TOP,
                        Block.box(0, 4, 0, 16, 13, 1),
                        Block.box(3, 4, 1, 16, 13, 8),
                        Block.box(0, 4, 8, 16, 13, 16)
                ),
