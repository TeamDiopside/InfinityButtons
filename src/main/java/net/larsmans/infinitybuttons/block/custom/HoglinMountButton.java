...
public class HoglinMountButton extends HorizontalFacingBlock {
    ...
    protected void playClickSound(@Nullable PlayerEntity player, WorldAccess world, BlockPos pos, boolean pressed) {
        world.playSound(pressed ? player : null, pos, getClickSound(pressed), SoundCategory.BLOCKS, 0.3f, 1f);
    }
