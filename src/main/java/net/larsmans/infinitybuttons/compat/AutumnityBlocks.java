...
public class AutumnityBlocks {
    ...
    public static final RegistryObject<Block> MAPLE_BOOKSHELF_SECRET_BUTTON = registerBlock("maple_bookshelf_secret_button",
            () -> new CompatBookshelfSecretButton(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).ignitedByLava().strength(1.5f).noOcclusion().sound(SoundType.WOOD), ForgeRegistries.BLOCKS.getValue(new ResourceLocation("autumnity", "maple_bookshelf"))));
