...
public class PrismarineButton extends AbstractSmallButton implements Waterloggable {
    ...
    public PrismarineButton(Settings settings, boolean large) {
    ...
    public BlockState getStateForNeighborUpdate(BlockState state, Direction direction, BlockState neighborState, WorldAccess world, BlockPos pos, BlockPos neighborPos) {
        if (getDirection(state).getOpposite() == direction && !state.canPlaceAt(world, pos) && !state.get(WATERLOGGED)) {
