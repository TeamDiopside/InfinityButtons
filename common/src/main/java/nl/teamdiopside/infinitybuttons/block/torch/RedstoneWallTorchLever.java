...
public class RedstoneWallTorchLever extends RedstoneWallTorchButton {
    ...
    public RedstoneWallTorchLever(Settings settings, Block jadeBlock) {
    ...
    public void powerOn(BlockState state, World world, BlockPos pos) {
        world.setBlockState(pos, state.with(LIT, true), NOTIFY_ALL);
        this.updateNeighbors(state, world, pos);
    }

    public void powerOff(BlockState state, World world, BlockPos pos) {
        world.setBlockState(pos, state.with(LIT, false), NOTIFY_ALL);
        this.updateNeighbors(state, world, pos);
    }
}
