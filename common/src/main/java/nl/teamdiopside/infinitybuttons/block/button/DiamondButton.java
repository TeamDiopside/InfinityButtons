...
import nl.teamdiopside.infinitybuttons.particle.InfinityButtonsParticleTypes;
...
public class DiamondButton extends AbstractSmallButton {
    ...
    public DiamondButton(Settings settings, boolean large) {
    ...
    public void randomDisplayTick(BlockState state, World world, BlockPos pos, Random random) {
        if (InfinityButtons.CONFIG.diamondParticles() && random.nextInt(3) == 0) {
            if (large) {
